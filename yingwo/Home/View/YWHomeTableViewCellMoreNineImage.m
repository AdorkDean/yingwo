//
//  YWHomeTableViewCellMoreNineImage.m
//  yingwo
//
...
@implementation YWHomeTableViewCellMoreNineImage

- (void)createSubview {
    self.backgroundView = [[UIView alloc] init];
    self.labelView      = [[YWHomeCellLabelView alloc] init];
    self.contentText    = [[YWContentLabel alloc] initWithFrame:CGRectZero];
    self.middleView     = [[YWHomeCellMiddleViewMoreNineImage alloc] initWithImagesNumber:9];
