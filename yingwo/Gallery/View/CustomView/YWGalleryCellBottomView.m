...
- (void)selectBottomView:(UITapGestureRecognizer *) tap{
    ...
    YWGalleryCellBottomView *bottomView = (YWGalleryCellBottomView *)[[tap view] superview];
    if ([self.delegate respondsToSelector:@selector(didSelectBottomView:)]) {
        [self.delegate didSelectBottomView:bottomView];
    }
