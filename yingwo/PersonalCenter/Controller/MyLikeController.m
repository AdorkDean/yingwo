...
@interface MyLikeController ()<UITableViewDataSource,UITableViewDelegate,YWGalleryViewDelegate,YWAlertButtonProtocol,YWSpringButtonDelegate,TTTAttributedLabelDelegate>
...
//    
//    __weak MyLikeController *weakSelf = self;
