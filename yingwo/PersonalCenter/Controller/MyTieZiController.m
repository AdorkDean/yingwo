...
@interface MyTieZiController ()<UITableViewDataSource,UITableViewDelegate,YWGalleryViewDelegate,YWAlertButtonProtocol,YWSpringButtonDelegate,YWTitleDelegate,TTTAttributedLabelDelegate>
...
//        
//        [_homeTableview registerClass:[YWGalleryCellOfOne class]
...
//        [_homeTableview registerClass:[YWGalleryCellOfTwo class]
//               forCellReuseIdentifier:YWHomeCellTwoImageIdentifier];
//        [_homeTableview registerClass:[YWGalleryCellOfThree class]
//               forCellReuseIdentifier:YWHomeCellThreeImageIdentifier];
//        [_homeTableview registerClass:[YWGalleryCellOfFour class]
//               forCellReuseIdentifier:YWHomeCellFourImageIdentifier];
//        [_homeTableview registerClass:[YWGalleryCellOfSix class]
//               forCellReuseIdentifier:YWHomeCellSixImageIdentifier];
//        [_homeTableview registerClass:[YWGalleryCellOfNine class]
//               forCellReuseIdentifier:YWHomeCellNineImageIdentifier];
//        [_homeTableview registerClass:[YWGalleryCellOfMoreNine class]
