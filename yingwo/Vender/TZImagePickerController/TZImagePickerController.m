...
//    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(83/255.0) green:(179/255.0) blue:(17/255.0) alpha:0.5];
    self.oKButtonTitleColorNormal = [UIColor colorWithHexString:THEME_COLOR_1];
    self.oKButtonTitleColorDisabled = [UIColor colorWithHexString:THEME_COLOR_1 alpha:0.5];
    if (iOS7Later) {
...
//        self.maxImagesCount = maxImagesCount > 0 ? maxImagesCount : 9; // Default is 9 / 默认最大可选9张图片
        self.maxImagesCount = maxImagesCount > 0 ? maxImagesCount : 0; // Default is 9 / 默认最大可选9张图片 小于等于0张置为0
